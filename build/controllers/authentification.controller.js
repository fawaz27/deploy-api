...
class AuthentificationController {
    constructor() {
        ...
        this.registration = (request, response, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const created = yield this.authService.register(TeacherData);
        ...
        this.logIn = (request, response, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { cookie, result } = yield this.authService.logIn(login);
    ...
    initializeRoutes() {
        this.router.post(`${this.path}/register`, (0, validationMiddleware_1.default)(teacher_dto_1.default), this.registration);
